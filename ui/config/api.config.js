...
export const API_CONFIG = {
  ...
  // Mock server configuration (auto-switches when backend is offline)
  MOCK_SERVER: {
    ENABLED: false,  // Set to true to force mock mode
    AUTO_DETECT: true,  // Enabled — fallback to mock when backend API is offline
  },
